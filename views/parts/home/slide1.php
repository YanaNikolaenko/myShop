        ...
        <div class="slick1">
            ...
            <?php foreach ($sliders as $slider): ?>
                ...
                <div class="item-slick1 item3-slick1"
                     style="background-image: url(<?= TEMPLATE_ROOT . $slider['image'] ?>);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                        ...
                        <div class="wrap-btn-slide1 w-size1 animated visible-false"
                             data-appear=<?= $slider['small_style'] ?>>
                            <!-- Button -->
                            <a href="<?= $slider['link'] ?>"
                               class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4" target="_blank">
                                <?= $slider['label'] ?>
                            </a>
                        </div>
                    </div>

...
<?php
if ($user !== null):?>
<a href="/profile"><div class="nameUser"><?=$user['firstname']?></div></a>
<?endif;?>
...
<!--форма профайла-->
                        <div class="header-cart header-dropdown login-dropdown">
                            <div style="font-size: 15px; padding-bottom: 5px; text-align:  center;">
                                User:
                            </div>
                            <div>
                                <div class="myprof">
                                    <div style="float: left; padding: 5px 0 0 20px">Firstname:</div><div style="float: right; padding: 5px 20px 0 0"><?=$user['firstname']?></div>
                                </div>
                            </div>

                            <div>
                                <div class="myprof">
                                    <div style="float: left; padding: 5px 0 0 20px">Lastname:</div><div style="float: right; padding: 5px 20px 0 0"><?=$user['lastname']?></div>
                                </div>
                            </div>

                            <div>
                                <div class="myprof">
                                    <div style="float: left; padding: 5px 0 0 20px">Email:</div><div style="float: right; padding: 5px 20px 0 0"><?=$user['email']?></div>
                                </div>
                            </div>
                            <div class="w-size10">
                                <a href="/profile">
                                    <div class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4" style="font-size: 15px; cursor: pointer">
                                        Go to profile
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="register" style="font-size: 15px; text-align: center; margin-top: 15px;">

...
class AddProducts extends Migration
{
    public static function AddProducts()
    {
        ...
        Product::create(3, "Black Jacket", 190.0, 20, 1, 0, "This is a beautiful black jacket", "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.");

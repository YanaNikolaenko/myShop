...
class AddSlider extends Migration
{
    ...
    {
        Slider::create("My Own", "inscription", "images/master-slide-02.jpg", 'mail.ru', 'www.mail.ru', 'rotateInDownLeft', 'rotateInUpRight', 'rotateIn');
        Slider::create("YANA YANA YANA", "My new subtitle", "images/master-slide-01.jpg", "onliner.by","www.onliner.by", 'rollIn', 'lightSpeedIn', 'slideInUp');

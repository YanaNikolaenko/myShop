...
class Product
{
    ...
    public static function selectAllProducts () : array
    {
        ...
        $j=0;
        for ($i=0; $i<=$count_img-3; $i+=3)//итерации цикла с шагом в 3, т.к. на каждый продукт есть 3 фото, а для для каталога мы выводим первую из трёх
        {
